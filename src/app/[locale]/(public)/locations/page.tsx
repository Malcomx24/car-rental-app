      ...
      <section className="bg-gradient-to-br from-gray-950 to-purple-950 text-white py-16 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-300 text-lg max-w-xl">
            {t("heroDescription", { count: locations.length > 0 ? locations.length : "25+" })}
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16">
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <h2 className="text-2xl font-bold mb-2">{t("comingSoonTitle")}</h2>
              ...
              <Card key={location.id} className="group hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <Badge variant="secondary" className="shrink-0">{t("active")}</Badge>
                  </div>
