...
import {
  ...
  Mail, Phone, Calendar, Shield, Star, Eye, X,
} from "lucide-react";
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="font-medium">{formatCurrency(selectedCustomer.totalSpent)} spent</span>
                    </div>
                  </div>
                  ...
                  {selectedCustomer.bookings.length > 0 && (
                    <div>
                      <h3 className="font-semibold text-sm mb-3">Recent Bookings</h3>
