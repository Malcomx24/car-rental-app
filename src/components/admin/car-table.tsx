...
import { Search, MoreHorizontal, Plus, Pencil, Trash2, Eye, Star, Loader2, ChevronLeft, ChevronRight, Filter, X } from "lucide-react";
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-xs text-muted-foreground">{car.brand?.name ?? "Unknown"} &middot; {car.licensePlate}</p>
                          </div>
                        </div>
                      </td>
                      <td className="p-4 hidden md:table-cell">
                        <span className="text-sm">{car.category?.name ?? "Unknown"}</span>
                      </td>
                      <td className="p-4">
                        <span className="text-sm font-medium">{formatCurrency(car.pricePerDay)}</span>
                      </td>
                      <td className="p-4 hidden sm:table-cell">
                        <span className="text-sm">{car.year}</span>
                      </td>
                      <td className="p-4">
                        <Badge variant="secondary" className={STATUS_COLORS[car.status]}>
