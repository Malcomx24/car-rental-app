...
async function main() {
  ...
  const locationData = [
    {
      ...
      slug: "centre-ville-casablanca",
      address: "Boulevard Mohammed V, 20000",
      city: "Casablanca",
      state: "Casablanca-Settat",
      country: "MA",
      zipCode: "20000",
      phone: "+212 522 12 34 56",
      email: "casablanca@driverent.ma",
      latitude: 33.5731,
      longitude: -7.5898,
      isAirport: false,
    },
    {
      ...
      slug: "aeroport-mohammed-v",
      address: "Aéroport International Mohammed V",
      city: "Casablanca",
      state: "Casablanca-Settat",
      country: "MA",
      zipCode: "20000",
      phone: "+212 522 53 90 40",
      email: "cmn@driverent.ma",
      latitude: 33.3675,
      longitude: -7.5898,
      isAirport: true,
    },
    {
      ...
      email: "agadir@driverent.ma",
      latitude: 30.4278,
      longitude: -9.5981,
      isAirport: false,
    },
    {
      name: "Aéroport Al Massira",
      slug: "aeroport-al-massira",
      ...
      email: "agadir-airport@driverent.ma",
      latitude: 30.3814,
      longitude: -9.4127,
      isAirport: true,
    },
    {
      ...
      country: "MA",
      zipCode: "40000",
      phone: "+212 524 43 55 66",
      email: "marrakech@driverent.ma",
      latitude: 31.6295,
      longitude: -7.9811,
      isAirport: false,
    },
    {
      ...
      slug: "aeroport-marrakech-menara",
    ...
    },
    {
      name: "Tangier Centre",
      slug: "tangier-centre",
      address: "Boulevard Mohammed V, Tangier",
      city: "Tanger",
      state: "Tanger-Tétouan-Al Hoceïma",
      country: "MA",
      zipCode: "90000",
      phone: "+212 539 33 44 55",
      email: "tanger@driverent.ma",
      latitude: 35.7595,
      longitude: -5.8340,
      isAirport: false,
    },
  ...
  // ── Settings ─────────────────────────────
  const settingsData = [
    { key: "company_name", value: "DriveRent Maroc", label: "Company Name", category: "GENERAL" as const, isPublic: true },
    { key: "company_email", value: "contact@driverent.ma", label: "Company Email", category: "GENERAL" as const, isPublic: true },
    { key: "company_phone", value: "+212 661 23 45 67", label: "Company Phone", category: "GENERAL" as const, isPublic: true },
    ...
    { key: "tax_rate", value: "0.20", label: "Tax Rate (20% TVA)", category: "PAYMENT" as const, type: "number" },
    { key: "security_deposit", value: "2000", label: "Default Security Deposit", category: "PAYMENT" as const, type: "number" },
    { key: "currency", value: "MAD", label: "Currency", category: "PAYMENT" as const, isPublic: true },
  ...
  const couponData = [
    {
      code: "BIENVENUE20",
      description: "20% de réduction sur votre première location",
    ...
    {
      code: "ETE25",
      description: "25% de réduction sur les locations estivales",
      type: "PERCENTAGE" as const,
      value: 25,
    ...
    {
      code: "REMISE500",
      description: "500 MAD de réduction sur toute location",
