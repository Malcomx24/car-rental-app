  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">{total} {total !== 1 ? t("invoicesTotalPlural") : t("invoicesTotal")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">{t("invoicesPaid")}</p>
        ...
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">{t("invoicesPending")}</p>
        ...
        <Card>
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">{t("invoicesOverdue")}</p>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-xl font-medium">{t("noInvoicesYet")}</p>
          <p className="text-muted-foreground mt-1">{t("invoicesGeneratedAfter")}</p>
        </div>
      ) : (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="text-right sm:ml-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {invoice.status === "PAID" ? `${t("paid")} ${formatDate(invoice.paidAt!)}` : `${t("due")} ${formatDate(invoice.dueDate)}`}
                    </p>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-center gap-2">
          ...
          <span className="text-sm text-muted-foreground">{tc("page")} {page} {tc("of")} {totalPages}</span>
