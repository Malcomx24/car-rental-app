  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">View and manage your reservations.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-muted-foreground mt-1">Try a different search or browse our cars.</p>
          <Link href="/cars">
