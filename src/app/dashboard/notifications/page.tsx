    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-xl font-medium">{filter === "unread" ? "No unread notifications" : "No notifications yet"}</p>
          <p className="text-muted-foreground mt-1">We&apos;ll notify you when something happens.</p>
        </div>
      ) : (
